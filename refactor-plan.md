...
* [ ] Phase 4: Data Model Cleanup (IN PROGRESS)
...
* [ ] **N22:** Remove hardcoded parameters from `ca.json.j2` and implement `step ca init` for proper CA reproducibility.
* [ ] **N9:** Verify or fix Caddy `:80` block so it doesn't suppress automated HTTPS redirects.
